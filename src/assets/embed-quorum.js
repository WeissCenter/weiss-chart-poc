...
var InjectQuorumEnvironment = function(element, name, code = "output \"Hello, World!\"", title = "Embed Quorum!", subtitle = "Enter Quorum code below and press \"Run Program\"", extraBuildFiles = []) {
